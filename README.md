...
We provide the following baselines for comparison:
  - **scai-qrecc21-simple-baseline**: simple baseline for passage retrieval and QA using original conversational questions without rewriting. We recommend to use [this code](https://github.com/scai-conf/SCAI-QReCC-21/tree/main/code/simple-baseline) as a boilerplate to kickstart your own submission using the VM.
